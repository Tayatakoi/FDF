...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/02 22:45:56 by samamaev          #+#    #+#             */
/*   Updated: 2026/01/03 22:36:41 by samamaev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	fill_row(t_fdf *tab, char **s_str, int row)
{
	int	col;
	...
	while (col < tab->width)
	{
		tab->map[row][col] = ft_atoi(s_str[col]);
		col++;
	}
}
